...
(после сессии). В строке урока (`TopicsTab`) у уроков с недоученными словами —
пилюля-мета «сессия ≈ 5 мин» (`m-pill-est`, фон `--surface-3`; статичная честная
оценка — сессии каппированы `SESSION_SIZE`); может соседствовать с «📖 новая».
